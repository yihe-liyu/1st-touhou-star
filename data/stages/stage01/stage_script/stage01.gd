...
# 组合式敌人（将来替代上面 ENEMY01.tres）:
# const AIMED = preload("res://data/patterns/aimed_burst.gd")
# const MOVE_DOWN = preload("res://data/patterns/move_down.gd")
# const S_RED = preload("res://data/enemy_visual/s_red.tscn")
