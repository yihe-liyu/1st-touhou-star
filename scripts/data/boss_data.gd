...
## 按难度取阶段（0=Easy 1=Normal 2=Hard 3=Lunatic；空难度组回退 Normal/phases）
...
func validate() -> Array[String]:
	...
	if phases.is_empty() and phases_easy.is_empty() and phases_hard.is_empty() and phases_lunatic.is_empty():
