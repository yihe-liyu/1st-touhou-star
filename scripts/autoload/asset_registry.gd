...
const bullet_configs := {
	...
	"bomb01":         {"tex": preload("res://assets/Textures/player/bomb01_01.png"), "hitbox": {"circle": 90.0, "offset": {"x": 0, "y": 0}}},
	"bomb01_white":   {"tex": preload("res://assets/Textures/player/bomb01_white.png"), "hitbox": {"circle": 90.0, "offset": {"x": 0, "y": 0}}},
